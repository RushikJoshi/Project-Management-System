    ...
    <AnimatePresence>
      {mobileSidebarOpen ? (
        <>
          ...
          >
            <div className="border-b border-surface-100 bg-white px-5 py-5 dark:border-surface-800">
              <div className="flex items-center">
                <img src="/logo_1.jpeg" alt="Gitakshmi" className="h-10 w-auto object-contain" />
              </div>
            </div>
