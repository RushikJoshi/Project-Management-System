...
import { Calendar, Flag, Search, User, X, Paperclip, Lock, Trash2, ChevronDown } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <div className="relative group">
                <select 
                  {...register('status')} 
                  className="input appearance-none border-surface-200/60 bg-white/50 pr-10 shadow-sm backdrop-blur-sm transition-all focus:bg-white dark:border-surface-700/50 dark:bg-surface-900/40 dark:focus:bg-surface-900"
                >
                ...
                <span className="absolute right-3 top-1/2 -translate-y-1/2 text-surface-400 pointer-events-none group-focus-within:text-brand-500 transition-colors">
                  <ChevronDown size={14} />
                </span>
              </div>
            </div>
              ...
              <Controller
                ...
                render={({ field }) => (
                  <DatePicker
                    ...
                    minDate={defaultDueDate}
                    className={cn(errors.dueDate && 'date-picker-error')}
                  />
                )}
              />
