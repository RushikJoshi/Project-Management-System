          ...
          <div className="flex-1 overflow-y-auto p-5 sm:p-6 space-y-6 custom-scrollbar">
            ...
            <div className="space-y-4 pt-2 border-t border-surface-50 dark:border-surface-800/50">
              <div className="flex items-center justify-between">
                <label className="text-[11px] font-bold uppercase tracking-widest text-surface-400 dark:text-surface-500 ml-1">SDLC Workflow Setup</label>
                <div className="text-[9px] font-black text-brand-600 dark:text-brand-400 uppercase tracking-widest">{totalDays} Total Days</div>
              </div>
