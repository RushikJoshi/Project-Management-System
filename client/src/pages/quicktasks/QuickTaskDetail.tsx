...
import { EmptyState, DatePicker } from '../../components/ui';
        ...
        <div className="flex items-start justify-between gap-4">
          <div className="min-w-0">
            <div className="flex items-center gap-2 flex-wrap mb-2">
              ...
              {task.completionReview?.reviewStatus && task.completionReview.reviewStatus !== 'pending' && (
                <span className={cn(
                  'badge text-[10px]',
                  task.completionReview.reviewStatus === 'approved'
                  ...
                  {task.completionReview.reviewStatus.replace('_', ' ')}
                </span>
              )}
              {task.isPrivate && (
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            <button
              className="btn-secondary btn-md shadow-sm border-surface-200/60 dark:border-surface-700/50"
            ...
            <button
              className="btn-ghost w-9 h-9 p-0 text-rose-500 hover:bg-rose-50 dark:hover:bg-rose-950/30"
              onClick={onDelete}
              disabled={!canEdit}
              title="Delete Task"
            >
