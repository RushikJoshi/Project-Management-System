...
function dueBadge(endDateTime?: string | null, dueDate?: string | null): string {
    const targetDate = endDateTime || dueDate;
...
export const AdminTaskCard = ({
    ...
    const dueText   = dueBadge(task.endDateTime, task.dueDate);
