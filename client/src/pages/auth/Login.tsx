...
export const LoginPage: React.FC = () => {
  ...
  // Clear any stale/expired tokens when landing on login page.
  // This prevents the axios interceptor from firing phantom refresh
  // requests that cause "timeout of 10000ms exceeded" error toasts.
  useEffect(() => {
    logout();
  }, []);
