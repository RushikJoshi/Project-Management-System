            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
              <div className="card border-surface-100 dark:border-surface-800 shadow-sm overflow-hidden bg-white dark:bg-surface-900">
                <div className="pt-10 pb-10 px-8 flex flex-col items-center">
                  ...
                  {/* Clean Stats Row */}
                  <div className="w-full flex items-center justify-center gap-12 py-6 border-t border-b border-surface-50 dark:border-surface-800/50">
                    <div className="text-center">
                      <p className="text-[10px] font-medium uppercase tracking-widest text-surface-300 mb-2">Performance</p>
                      <p className="text-2xl font-light text-surface-800 dark:text-surface-100">
                        {loadingPerformance ? '--' : `${performance?.summary.performanceScore ?? 0}%`}
                      </p>
                    </div>
                    <div className="w-px h-8 bg-surface-100 dark:bg-surface-800" />
                    <div className="text-center">
                      <p className="text-[10px] font-medium uppercase tracking-widest text-surface-300 mb-2">Avg Rating</p>
                      <p className="text-2xl font-light text-surface-800 dark:text-surface-100">
                        {loadingPerformance ? '--' : performance?.summary.averageRating ?? 0}
                      </p>
                    </div>
                  </div>
