export type Role = 'super_admin' | 'admin' | 'manager' | 'team_leader' | 'team_member' | 'CLIENT_ADMIN' | 'CLIENT_MANAGER' | 'CLIENT_REVIEWER' | 'CLIENT_VIEWER';
...
export interface Client {
  ...
  clientType: 'enterprise' | 'individual' | 'partner';
  logo?: string;
  timezone?: string;
  notes?: string;
