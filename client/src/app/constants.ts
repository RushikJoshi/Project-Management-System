...
export const ROLE_CONFIG = {
  ...
  CLIENT_ADMIN: { label: 'Client Admin', color: 'text-sky-600', bg: 'bg-sky-50 dark:bg-sky-950/30' },
  CLIENT_MANAGER: { label: 'Client Manager', color: 'text-cyan-600', bg: 'bg-cyan-50 dark:bg-cyan-950/30' },
  CLIENT_REVIEWER: { label: 'Client Reviewer', color: 'text-teal-600', bg: 'bg-teal-50 dark:bg-teal-950/30' },
  CLIENT_VIEWER: { label: 'Client Viewer', color: 'text-slate-600', bg: 'bg-slate-50 dark:bg-slate-900/40' },
} as const;
