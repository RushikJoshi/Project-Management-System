...
const taskSchema = new mongoose.Schema(
  {
    ...
    taskType: { type: String, default: 'operational', index: true },
    ...
    phaseId: { type: String, default: null, index: true },
    ...
    requestId: { type: mongoose.Schema.Types.ObjectId, ref: 'Ticket', default: null, index: true },
    createdFromRequest: { type: Boolean, default: false, index: true },
...
taskSchema.set('toJSON', {
  transform: (_doc, ret) => {
    ...
    ret.requestId = ret.requestId ? String(ret.requestId._id || ret.requestId.id || ret.requestId) : undefined;
    ret.createdFromRequest = Boolean(ret.createdFromRequest);
    delete ret._id;
    delete ret.__v;
    delete ret.tenantId;
